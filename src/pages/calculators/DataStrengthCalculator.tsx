...
export default function DataStrengthCalculator() {
  ...
  const [safariPctInput, setSafariPctInput] = useState<string>("40");
              ...
              <div className="form-grid">
                ...
                {(useBaseline || chSearch) && (
                  <div className="form-group" id="grp_search_spend">
                    <label htmlFor="search_spend">Monthly Google Ads Spend <span className="lbl-hint">(optional)</span></label>
                    <div className="input-wrap">
                      <input
                        type="number"
                        id="search_spend"
                ...
                <div className="form-group" id="grp_safari">
                  ...
                  <div className="input-wrap">
                    <input
                      ...
                      min="0"
                      max="100"
                      value={safariPctInput}
                      onChange={e => setSafariPctInput(e.target.value)}
                      style={{ paddingRight: "2rem" }}
                    />
                    <span className="suffix">%</span>
                  </div>
        ...
        {currentStep === 4 && (
          <div className="step active">
            <div className="card">
              ...
              {results.breakdown.length === 0 ? (
                <div className="no-features-msg">
                  Your data architecture is fully optimized and feeding your Algo maximum signal!
                </div>
              ) : (
                <>
