      ...
      <div className="container">
        <div className="progress-bar">
          <div className="step-item">
            ...
            <div className="step-label active" id="label1">Ingredients</div>
          </div>
          ...
          <div className="card">
            ...
            <div className="feature-row">
              ...
              <div className="adopt-slider-wrap" id="consent_mode_wrap">
                ...
                <div className="adopt-readout" id="consent_mode_slider_readout" />
              </div>
            </div>
            ...
            <div className="feature-row">
              ...
              <div className="adopt-slider-wrap" id="enhanced_conv_wrap">
                ...
                <div className="adopt-ticks"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div>
                <div className="adopt-readout" id="enhanced_conv_slider_readout" />
              </div>
            </div>
            ...
            <div className="feature-row">
              ...
              <div className="adopt-slider-wrap" id="gtg_wrap">
                ...
                <div className="adopt-ticks"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div>
                <div className="adopt-readout" id="gtg_slider_readout" />
              </div>
            </div>
            ...
            <div className="feature-row">
              ...
              <div className="adopt-slider-wrap" id="sgtm_wrap">
                ...
                <div className="adopt-ticks"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div>
                <div className="adopt-readout" id="sgtm_slider_readout" />
              </div>
            </div>
            ...
            <div className="sub-feature">
              ...
              <div className="sf-item">
                ...
                <div className="adopt-slider-wrap" id="meta_capi_wrap">
                  ...
                  <div className="adopt-ticks"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div>
                  <div className="adopt-readout" id="meta_capi_slider_readout" />
                </div>
              </div>
              <div className="sf-item">
                <div>
                ...
                <div className="adopt-slider-wrap" id="tiktok_eapi_wrap">
                  ...
                  <div className="adopt-ticks"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div>
                  <div className="adopt-readout" id="tiktok_eapi_slider_readout" />
                </div>
              </div>
            </div>
            ...
            <div className="feature-row">
              ...
              <div className="adopt-slider-wrap" id="bigquery_wrap">
                ...
                <div className="adopt-ticks"><span>0%</span><span>25%</span><span>50%</span><span>75%</span><span>100%</span></div>
                <div className="adopt-readout" id="bigquery_slider_readout" />
              </div>
            </div>
          </div>
        ...
        <div className="step" id="step2">
          ...
          <div className="btn-actions">
            ...
            <button className="btn btn-primary" type="button">Calculate Uplift &rarr;</button>
          </div>
        </div>
